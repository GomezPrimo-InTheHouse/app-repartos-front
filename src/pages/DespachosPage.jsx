...
function BadgesDespacho({ despacho }) {
  return (
    <div className="flex flex-col items-end gap-1">
      ...
      {/* Neutral y suave a propósito: no es un estado (éxito/error/alerta)
          sino una categoría informativa del despacho, así que no debe
          competir visualmente con los badges de arriba. whitespace-nowrap
          evita que el texto se parta en dos líneas dentro del pill. */}
      {despacho.tipo === 'solo_devolucion' && (
        <Badge className="whitespace-nowrap border-transparent bg-muted text-muted-foreground">
          Devolución
        </Badge>
      )}
